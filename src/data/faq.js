export const faqData = [
  ...
  },
  {
    ...
    answer:
      "Web sitemiz, Instagram hesabımız, telefon veya WhatsApp üzerinden kolayca randevu alabilirsiniz. Online rezervasyon da mevcuttur.",
    state: "closed",
  },
  {
    id: 4,
    question: "Sadece randevu ile mi çalışıyorsunuz?",
    answer:
      "Evet, her müşteriye özel zaman ayırabilmek için sadece randevu ile çalışıyoruz. Bu sayede bekleme süresi olmuyor.",
    state: "closed",
  },
  {
    id: 5,
    question: "Bir işlem ne kadar sürer?",
    answer:
      "Klasik manikür ve jel oje işlemi yaklaşık 1,5 saat sürmektedir. Süre, seçilen hizmete göre değişebilir.",
    state: "closed",
  },
  {
    id: 6,
    question: "Randevumu iptal edebilir veya değiştirebilir miyim?",
    answer:
      "Evet, randevu değişikliği veya iptali için lütfen en az 24 saat önceden bizimle iletişime geçin.",
    state: "closed",
  },
  {
    id: 7,
