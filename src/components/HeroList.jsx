        ...
        const heroData = [
                {
                        ...
                        buttons: (
                                <div className="flex gap-4 w-full max-md:flex-col">
                                        <AppointmentButton url={`https://wa.me/905060552137?text=${encodeURIComponent(
                                                `Merhaba! 500 TL olan kampanyanız için randevu almak istiyorum.`
                                        )}`}>Randevu Al</AppointmentButton>
                                </div>
                        ),
                },
                {
